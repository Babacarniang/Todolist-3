...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final String listItemArray [] = { "Babacar" , "Herver" , "Am dal" , "Magueye"};
        ...
        myClasslist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MainActivity.this, "Bien vue: "+listItemArray[position], Toast.LENGTH_LONG).show();
            }
        });
